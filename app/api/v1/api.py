...
from app.api.v1.endpoints import transactions, events, reminders, daybook, incoming_outgoing, modules, backups, firm_details, labour, production, setup
...
api_router.include_router(incoming_outgoing.router, prefix="/incoming_outgoing", tags=["incoming_outgoing"])
